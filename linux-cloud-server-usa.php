                        ...
                        <div class="container">
                            <div class="row align-items-center">
								<div class="col-md-12 text-center">
								    <h1>Best Cloud Server Hosting USA </h1>
									<h2>USA Based Linux Cloud Hosting</h2>						
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="pricing-s1 mb30">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=39" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="pricing-s1 mb30">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=40" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
										<div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="pricing-s1 mb30">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=41" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
                                    </div>
