                        ...
                        <div class="container">
                            <div class="row align-items-center">
								<div class="col-lg-6 col-12 text-lg-left text-center mb-sm-30">
									<h1 style='color:white '> VPS Hosting<span class="label">5% OFF</span></h1>
									<p class="lead">Uplift your digital landscape with our top-tier foreign VPS solutions, crafted to deliver speed and reliability across international markets – now with a special 20% discount on yearly commitments. </p>
									<div class="spacer-half"></div>
									<a class="btn-custom" href="#plans">See All Plans</a>
								</div>
								
								<div class="col-lg-3 offset-lg-2 col-4 offset-4 text-center">
									<img src="images/cloud-network-icon2.gif" class="img-fluid" alt="" style="opacity: 0.5;">
								</div>
                            </div>
                        </div>
                    </div>
			...
			<section id="plans" class="pb40" >
                <div class="container">
                            ...
                            <div class="text-center">
                                <h1 style="color:#115256">Best Foreign VPS  Hosting at Affordable Price</h1>
                                <h2><span class="uptitle id-color">Select Your</span>Foreign VPS Hosting</h2>
                                            ...
                                            <div class="pricing-s1 mb30">
                                                ...
                                                <div class="bottom">
                                                    <ul>
                                                        ...
                                                        <li><i class="fa fa-check-square"></i>80 GB Hard Disk-SSD</li>
                                                        <li><i class="fa fa-check-square"></i>1TB Bandwidth</li>
                                                        <li><i class="fa fa-check-square"></i>1 Dedicated IP</li>
                                                        <li><i class="fa fa-check-square"></i>Free CentOS WP-Cpanel</li>
                                            ...
                                            <div class="pricing-s1 mb30">
                                                ...
                                                <div class="bottom">
                                                    <ul>
                                                        ...
                                                        <li><i class="fa fa-check-square"></i>200 GB Hard Disk-SSD</li>
                                                        <li><i class="fa fa-check-square"></i>2TB Bandwidth</li>
                                                        <li><i class="fa fa-check-square"></i>1 Dedicated IP</li>
                                                        <li><i class="fa fa-check-square"></i>Free CentOS WP-Cpanel</li>
                                                        <li><i class="fa fa-check-square"></i>FREE Set Up!!</li>
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=28" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
