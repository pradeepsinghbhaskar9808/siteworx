...
ADD COLUMN address TEXT NULL AFTER company_name,
...
ADD COLUMN gst_number VARCHAR(20) NULL AFTER pin_code;


ALTER TABLE invoices
ADD tax_rate DECIMAL(5,2) DEFAULT 18.00,
ADD tax_amount DECIMAL(10,2) DEFAULT 0,
ADD due_date DATE NULL,
ADD invoice_no VARCHAR(50) NULL;


ALTER TABLE order_items
ADD gst_rate DECIMAL(5,2) DEFAULT 18.00;
