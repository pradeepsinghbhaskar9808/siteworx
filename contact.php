    <?php include('header.php'); ?>
        <div class="no-bottom no-top" id="support">
            <div id="top"></div>
            ...
            <section class="relative no-top no-bottom text-light" data-bgimage="url(images/background/10.jpg)" data-stellar-background-ratio=".2">
                ...
                <div class="overlay-gradient t80">
                    <div class="center-y">
						...
						<div class=" col-lg-5 offset-lg-2 mb-sm-30">			
							<form name="contactForm" id='contact_form' class="form-s1" method="post" action='/contact-us'>
						...
						<div class="col-lg-4 mb30">
                                            ...
                                            <div class="padding40 bg-gradient-to-right-2 text-light rounded">
												<h3>Our Office</h3>
												<address class="s1">												
												<span><i class="fa fa-map-marker fa-lg"></i>305, Maa Hinglaj Nagar Lalaerpura Road Vaishali Nagar Jaipur 302021</span>
												<span><i class="fa fa-phone fa-lg"></i><a href="tel:8905585799">8905585799</a></span>
												<span><i class="fa-solid fa-envelope"></i><a href="mailto:admin@siteworx.in">info@siteworx.in</a></span>
 											</address>
											</div>
