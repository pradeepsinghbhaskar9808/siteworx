                        ...
                        <div class="container">
                            <div class="row align-items-center">
								<div class="col-lg-6 col-12 text-lg-left text-center mb-sm-30">
									...
									<p class="lead"> Supercharge your online experience with our India Linux/Windows VPS hosting – a perfect balance of power, flexibility, and affordability for your growing digital needs. </p>
			...
			<section id="plans" class="pb40" >
                <div class="container">
                            ...
                            <div class="text-center">
                                <h1 style="color:#115256">India's Best  VPS  Hosting At Affordable Price</h1>
                                <h2><span class="uptitle id-color">Select Your</span>India  VPS Hosting</h2>
                                <div class="spacer-20"></div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="pricing-s1 mb30">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=17" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="pricing-s1 mb30">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=18" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
										<div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="pricing-s1 mb30">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=19" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
