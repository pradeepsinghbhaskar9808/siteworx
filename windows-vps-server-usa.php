                        ...
                        <div class="container">
                            <div class="row align-items-center">
								<div class="col-md-12 text-center">
								    <h1>Best Windows VPS Server Hosting In USA at Lowest Cost</h1>
									<h2> USA Windows VPS Hosting </h2>						
                                            ...
                                            <div class="pricing-s1 mb30">
                                                <div class="top">
                                                    ...
                                                    <p class="price">
														...
														<span class="m opt-1">849</span>
														<span class="y opt-2">799</span>
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=29" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="pricing-s1 mb30">
                                                ...
                                                <div class="top">
                                                    ...
                                                    <p class="price">
														<span class="txt">Start from</span>
														<span class="currency">INR</span>
														<span class="m opt-1">1799</span>
														<span class="y opt-2">1599</span>
														<span class="month">p/mo</span>
													</p>     
                                                </div>
                                                <div class="bottom">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=30" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
										<div class="col-lg-3 col-md-6 col-sm-12">
                                            <div class="pricing-s1 mb30">
                                                <div class="top">
                                                    ...
                                                    <p class="price">
														<span class="txt">Start from</span>
														<span class="currency">INR</span>
														<span class="m opt-1">2799</span>
														<span class="y opt-2">2599</span>
														<span class="month">p/mo</span>
													</p>     
                                                </div>
                                                <div class="bottom">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=31" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="pricing-s1 mb30">
                                                <div class="top">
                                                    ...
                                                    <p class="price">
														<span class="txt">Start from</span>
														<span class="currency">INR</span>
														<span class="m opt-1">3699</span>
														<span class="y opt-2">3299</span>
														<span class="month">p/mo</span>
													</p>     
                                                </div>
                                                <div class="bottom">
												...
												<div class="action">
													<a href="http://siteworx.in/manage/cart.php?a=add&pid=32" class="btn-custom">Order Now</a>
												</div>
                                            </div>
                                        </div>
            ...
            <section id="section-testimonial" class="no-top no-bottom text-light" data-bgimage="url(images/background/1.jpg) center" data-stellar-background-ratio=".2">
                <div class="overlay-gradient">
                    <div class="text-center wow fadeInUp">
                        <h2><span class="uptitle">web Development Service</span>& Hosting Provider in jaipur</h2>
                        <div class="spacer-20"></div>
                    </div>
